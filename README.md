...
/translate language:🇯🇵 日本語 (ja) text:How are you doing?
→ 調子はどう？

/translate language:🇨🇳 中文（简体） (zh-cn) text:こんにちは
→ 你好

# 詳細表示（原文と言語情報も表示）
/translate language:🇺🇸 English (en) text:今日はいい天気ですね show_details:True
→ 🇯🇵 → 🇺🇸
   原文: 今日はいい天気ですね
